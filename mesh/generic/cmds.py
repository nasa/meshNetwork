...
NodeCmds = {'GCSCmd': 10, 'FormationCmd': 20, 'ParamUpdate': 30, 'ConfigRequest': 40, 'ConfigHash': 41}

PixhawkCmds = NodeCmds.copy()
PixhawkCmds.update({'NodeStateUpdate': 111, 'StateUpdate': 101, 'TargetUpdate': 105, 'PosCmd': 100})
...
cmdsToRelay = [PixhawkCmds['GCSCmd'], PixhawkCmds['ConfigRequest'], PixhawkCmds['ParamUpdate'], TDMACmds['BlockTxRequest'], TDMACmds['BlockTxRequestResponse'], TDMACmds['BlockTxConfirmed'], TDMACmds['BlockTxStatus'], TestCmds['SendDataBlock']]
